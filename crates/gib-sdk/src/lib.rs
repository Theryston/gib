...
pub use api::{
    Author, AuthorIdentity, BackupReference, ByteRange, CURRENT_IDENTITY_CONFIGURATION_VERSION,
    CURRENT_SNAPSHOT_HISTORY_VERSION, CURRENT_SNAPSHOT_SUMMARY_VERSION, CURRENT_SNAPSHOT_VERSION,
    CURRENT_STORAGE_BACKEND_VERSION, CURRENT_STORAGE_CONFIGURATION_VERSION, CancellationHandle,
    CancellationInfo, CancellationToken, Client, ClientBuilder, ConfigurationError,
    ConfigurationHandle, ConfigurationResult, ConfigurationStorage, CredentialReference,
    CredentialStore, CredentialStoreError, CredentialStoreHandle, CredentialStoreOperation,
    CredentialStoreResult, DEFAULT_EVENT_BUFFER_CAPACITY, DEFAULT_OBJECT_LIST_PAGE_SIZE,
    DEFAULT_SNAPSHOT_PAGE_SIZE, EVENT_SCHEMA_VERSION, ErrorCode, ErrorSummary, EventConsumer,
    ...
    MemoryIdentityConfiguration, MemoryStorage, MemoryStorageOperation, ObjectCursor, ObjectKey,
    ObjectListPage, ObjectListRequest, ObjectMetadata, ObjectPrefix, ObjectRange, ObjectRead,
    ObjectReader, ObjectStorage, ObjectWriteOptions, OpenRepositoryRequest, OperationHandle,
    OperationId, OperationKind, OperationRequest, OperationResult, OperationStatus, Progress,
    REPOSITORY_BOOTSTRAP_VERSION, REPOSITORY_DESCRIPTOR_VERSION, REPOSITORY_FORMAT_VERSION,
    RecoveryPoint, Repository, RepositoryDescriptor, RepositoryFeature, RepositoryHead,
    ...
    SNAPSHOT_OBJECT_PREFIX, STORAGE_CONFIGURATION_FILE_SUFFIX, STORAGE_TRANSFER_BUFFER_SIZE,
    SdkError, SdkResult, SetAuthorRequest, SetIdentityRequest, Snapshot, SnapshotCursor,
    ...
    SnapshotSummaryListRequest, SnapshotSummaryPage, StorageBackend, StorageBackendKind,
    StorageCapabilities, StorageCapability, StorageConfiguration, StorageConfigurationError,
    StorageConfigurationOperation, StorageConfigurationResult, StorageConfigurationStore,
    StorageCredentialKind, StorageCredentials, StorageError, StorageHandle, StorageKey,
    StorageListPage, StorageListRequest, StorageMetadata, StorageName, StoragePrefix, StorageRange,
    ...
    decode_snapshot_object, encode_snapshot_object, get_author, get_global_identity, get_identity,
    initialize_repository, open_repository, read_identity, set_author, set_global_identity,
    set_identity,
};
