...
pub use api::{
    ...
    DEFAULT_SNAPSHOT_PAGE_SIZE, DefaultStorageConnectivity, EVENT_SCHEMA_VERSION, ErrorCode,
    ...
    add_storage, calculate_object_id_for_content, decode_immutable_object,
    decode_immutable_object_from_reader, decode_object, decode_snapshot_object,
    encode_immutable_object, encode_object, encode_snapshot_object, get_author,
    get_global_identity, get_identity, initialize_repository, list_storages, object_id_for_content,
    open_repository, read_identity, remove_storage, set_author, set_global_identity, set_identity,
};
