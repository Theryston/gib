...
pub use api::{
    ...
    LocalIdentityConfiguration, LocalStorage, MAX_AUTHOR_IDENTITY_LENGTH, MAX_AUTHOR_LENGTH,
    ...
    MemoryConfiguration, MemoryIdentityConfiguration, MemoryStorage, MemoryStorageOperation,
