...
pub use api::{
    AddStorageRequest, Author, AuthorIdentity, BackupReference, ByteRange,
    CURRENT_IDENTITY_CONFIGURATION_VERSION, CURRENT_SNAPSHOT_HISTORY_VERSION,
    CURRENT_SNAPSHOT_SUMMARY_VERSION, CURRENT_SNAPSHOT_VERSION, CURRENT_STORAGE_BACKEND_VERSION,
    CURRENT_STORAGE_CONFIGURATION_VERSION, CancellationHandle, CancellationInfo, CancellationToken,
    ...
    DEFAULT_EVENT_BUFFER_CAPACITY, DEFAULT_OBJECT_LIST_PAGE_SIZE, DEFAULT_SNAPSHOT_PAGE_SIZE,
    ...
    IdentityStorageResult, InitializeRepositoryRequest, LATEST_SNAPSHOT_ALIAS, ListCursor,
    ...
    MAX_AUTHOR_IDENTITY_LENGTH, MAX_AUTHOR_LENGTH, MAX_OBJECT_LIST_PAGE_SIZE,
    ...
    MemoryStorageOperation, ObjectCursor, ObjectKey, ObjectListPage, ObjectListRequest,
    ObjectMetadata, ObjectPrefix, ObjectRange, ObjectRead, ObjectReader, ObjectStorage,
    ObjectWriteOptions, OpenRepositoryRequest, OperationHandle, OperationId, OperationKind,
    OperationRequest, OperationResult, OperationStatus, PlatformCredentialStore, Progress,
    ...
    add_storage, decode_snapshot_object, encode_snapshot_object, get_author, get_global_identity,
    get_identity, initialize_repository, list_storages, open_repository, read_identity,
    remove_storage, set_author, set_global_identity, set_identity,
};
